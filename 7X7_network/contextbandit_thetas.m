function [thetat,Arms,Regret,Y,MaxUtil,ChosenUtil]=contextbandit_thetas(T,tau,Ratings,ConstFlux,RouteCost,RealTheta,poi,alpha)
...
ARM=struct;
for a=1:poi
    ARM(a).ThetaReal=[ConstFlux(a,1),RealTheta(1,2:3)];
